...
class __TwigTemplate_b73889220b42849461ae3221192f95dd22a69ebcbe3969007e67a2c8fa326c5c extends Twig_Template
{
...
(isset($context["context"]) ? $context["context"] : null), "pager", array()), "showingFrom", array()), "%to%" => $this->getAttribute($this->getAttribute(            // line 10
(isset($context["context"]) ? $context["context"] : null), "pager", array()), "showingTo", array()), "%count%" => $this->getAttribute($this->getAttribute(            // line 11
...
";
    ...
    {
        return new Twig_Source("", "@bolt/components/pager.twig", "");
    }
}
