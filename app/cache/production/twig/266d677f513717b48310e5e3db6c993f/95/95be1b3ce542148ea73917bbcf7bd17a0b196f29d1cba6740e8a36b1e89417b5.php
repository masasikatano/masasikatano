...
(isset($context["taxonomy"]) ? $context["taxonomy"] : null), "allow_spaces", array()));
    ...
    public function block_fieldset_controls($context, array $blocks = array())
    {
        // line 39
        echo "    ";
        $context["__internal_88ff54495f3d82276dbb79524ec767fdf2dc9e30353ad3030d33cafaa64f4242"] = $this->loadTemplate("@bolt/_buic/_select.twig", "@bolt/editcontent/fields/_tags.twig", 39);
        // line 40
        echo "
    <div class=\"col-sm-9\">
        ";
        // line 42
        echo $context["__internal_88ff54495f3d82276dbb79524ec767fdf2dc9e30353ad3030d33cafaa64f4242"]->getbuic_select((isset($context["buic_opt_select"]) ? $context["buic_opt_select"] : null));
        echo "
        ";
        // line 43
