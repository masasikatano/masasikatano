...
(isset($context["context"]) ? $context["context"] : null), "can", array()), "change_ownership", array()), "name_id" => "changelog-comment", "placeholder" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Add a brief, optional comment to describe what's changed."), "type" => "text"));
    ...
    public function block_fieldset_controls($context, array $blocks = array())
    {
        // line 59
        echo "    ";
        $context["__internal_c6e9f1ad1eb78c2cd9ec526e9d3fdbba53e84377a33c5e44034bcf328395fdd1"] = $this->loadTemplate("@bolt/_buic/_moment.twig", "@bolt/editcontent/fields/_meta.twig", 59);
        // line 60
        echo "
    <div class=\"col-xs-12\">
        ";
        ...
        if (($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "content", array()), "datecreated", array()) > "1970-01-01 01:01:01")) {
            ...
            echo "
                        ";
            // line 75
            echo $context["__internal_c6e9f1ad1eb78c2cd9ec526e9d3fdbba53e84377a33c5e44034bcf328395fdd1"]->getbuic_moment($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "content", array()), "datecreated", array()));
            echo "
                        ";
            // line 76
            ...
            echo "
                        ";
            // line 77
            echo $context["__internal_c6e9f1ad1eb78c2cd9ec526e9d3fdbba53e84377a33c5e44034bcf328395fdd1"]->getbuic_moment($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "content", array()), "datechanged", array()));
            echo ".
                    </p>
                ";
        }
